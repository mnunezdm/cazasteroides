...
(function(window, undefined) {
  ...
  jQuery.extend(jimEvent.fn, {
    ...
    "jimCreateDrag": function(drag, $target, args) {
      var self = this, $drag, paneWidth = jimUtil.getSidePanelWidth(), $master, position, dragData, dragTargets;
    ...
    "jimMove": function(args, callback) {
      if(jimUtil.exists(args)) {
        var self = this, $targets, t, tLen, $target, eventData, dragData, position, newTopPosition, newLeftPosition, $parent, containment, $svg, effect;
        var CCWrapper=true;
        var properties = {};
