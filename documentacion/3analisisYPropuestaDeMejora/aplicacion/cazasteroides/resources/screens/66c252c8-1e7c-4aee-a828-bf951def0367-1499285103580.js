jQuery("#simulation")
  .on("click", ".s-66c252c8-1e7c-4aee-a828-bf951def0367 .click", function(event, data) {
    ...
    if(jFirer.is("#s-Rectangle_11")) {
              ...
              "actions": [
                {
                  ...
                  "parameter": {
                    "target": "screens/70309ff9-384f-48d8-8ae4-e0975cc4ecc3",
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/9d0b23f0-e3f1-4389-8618-affa0c690df4",
                    "transition": "slideleft"
                  },
                  "exectype": "serial",
                  "delay": 0
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/e89e3cab-b952-46d2-8888-56c05c9f4343",
                    "transition": "slideleft"
                  },
                  "exectype": "serial",
                  "delay": 0
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-VoteButton")) {
      cases = [
        {
          "blocks": [
            {
              ...
              "actions": [
                {
                  "action": "jimNavigation",
                  "parameter": {
                    "target": "screens/c05fdd39-8da5-4c07-b36b-ebd91ce0a3e4",
      ...
      event.data = data;
      jEvent.launchCases(cases);
    } else if(jFirer.is("#s-more-vertical_1")) {
      cases = [
        {
          "blocks": [
            {
  ...
  .on("focusin", ".s-66c252c8-1e7c-4aee-a828-bf951def0367 .focusin", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
  ...
  .on("focusout", ".s-66c252c8-1e7c-4aee-a828-bf951def0367 .focusout", function(event, data) {
    var jEvent, jFirer, cases;
    if(data === undefined) { data = event; }
    jEvent = jimEvent(event);
    jFirer = jEvent.getEventFirer();
